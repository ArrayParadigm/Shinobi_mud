...
class NPCFoundationTests(unittest.TestCase):
    ...
    def tearDown(self):
        if veilborn_mud.WORLD_TICK_LOOP and veilborn_mud.WORLD_TICK_LOOP.running:
            veilborn_mud.WORLD_TICK_LOOP.stop()
        veilborn_mud.WORLD_TICK_LOOP = None
        veilborn_mud.players_in_rooms.clear()
        veilborn_mud.WORLD_OVERLAYS.clear()
    ...
    def test_world_tick_updates_persistent_npc_timestamp(self):
        ...
        veilborn_mud.start_world_tick(clock)
        clock.advance(veilborn_mud.WORLD_TICK_INTERVAL_SECONDS)
