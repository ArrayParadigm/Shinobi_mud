...
# Database setup
conn = sqlite3.connect('mud_game_gmud_compatible.db')
cursor = conn.cursor()
...
class NinjaMUDProtocol(basic.LineReceiver):
    delimiter = b"\r\n"  # Use CRLF to ensure compatibility with GMUD
    ...
    def connectionMade(self):
        # Telnet handshake message to improve compatibility with clients like GMUD
