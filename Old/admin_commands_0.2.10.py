...
COMMANDS = {
    ...
    "look": lambda protocol, players_in_rooms: look(protocol),
    "north": lambda protocol, players_in_rooms: move(protocol, "north"),
    "south": lambda protocol, players_in_rooms: move(protocol, "south"),
}
