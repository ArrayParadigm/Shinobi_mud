...
# Database setup with table creation check
conn = sqlite3.connect('mud_game_with_db_fix.db')
cursor = conn.cursor()
...
# Hardcoded Celestial Sanctuary Rooms (Full 30+ rooms)
full_hardcoded_rooms = [
    ...
    # Other rooms as before, fully defined here to total at least 30+ rooms
]

# Insert rooms only if they don't already exist
