...
# Database setup
conn = sqlite3.connect('mud_game_with_eve_domain.db')
cursor = conn.cursor()
...
# Eve's Domain (Fallback Celestial Sanctuary)
eve_domain_rooms = [
    {
        "id": 1000,
        "name": "The Celestial Garden",
        "description": "You stand in a tranquil garden filled with glowing plants. The sky above shimmers with countless stars.",
        "exits": "{"north": 1001, "east": 1002}"
    },
    {
        "id": 1001,
        "name": "The Hall of Echoes",
        "description": "A grand hall where murals come alive, telling the stories of past heroes. The air hums with their whispered legends.",
        "exits": "{"south": 1000}"
    },
    {
        "id": 1002,
        "name": "The Starlit Path",
        "description": "A narrow path lined with twinkling stars. It seems to stretch infinitely, inviting you to explore its mysteries.",
        "exits": "{"west": 1000, "north": 1003}"
    },
    {
        "id": 1003,
        "name": "The Reflection Pool",
        "description": "A calm pool of water that reflects not only your appearance but also glimpses of your past and future.",
        "exits": "{"south": 1002, "east": 1004}"
    },
    {
        "id": 1004,
        "name": "The Archive of Realms",
        "description": "A vast library filled with floating books, each containing knowledge of different worlds. The air crackles with potential energy.",
        "exits": "{"west": 1003}"
    }
]

for room in eve_domain_rooms:
