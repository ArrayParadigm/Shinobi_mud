...
def ensure_tables_exist():
    try:
        ...
        cursor.execute('''INSERT OR IGNORE INTO rooms (id, name, description, exits) VALUES
            (1000, "Default Room", "This is the starting room.", '{"north": 1001, "south": 1002, "east": 1003, "west": 1004}')''')

        # Add some other connected rooms as examples
        cursor.execute('''INSERT OR IGNORE INTO rooms (id, name, description, exits) VALUES
            (1001, "Northern Room", "This is the room to the north.", '{"south": 1000}')''')
        cursor.execute('''INSERT OR IGNORE INTO rooms (id, name, description, exits) VALUES
            (1002, "Southern Room", "This is the room to the south.", '{"north": 1000}')''')
        cursor.execute('''INSERT OR IGNORE INTO rooms (id, name, description, exits) VALUES
            (1003, "Eastern Room", "This is the room to the east.", '{"west": 1000}')''')
        cursor.execute('''INSERT OR IGNORE INTO rooms (id, name, description, exits) VALUES
            (1004, "Western Room", "This is the room to the west.", '{"east": 1000}')''')
