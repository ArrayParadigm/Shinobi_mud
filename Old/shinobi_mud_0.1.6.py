...
# Database setup
conn = sqlite3.connect('mud_game_gmud_input_fix.db')
cursor = conn.cursor()
...
class NinjaMUDProtocol(basic.LineReceiver):
    delimiter = b"\n"  # Use LF for broader compatibility, but process manually
    ...
    def lineReceived(self, line):
        # Debugging to track inputs
        self.sendLine(b"[DEBUG] Received line: " + line)
